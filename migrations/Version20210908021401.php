 ...
 */
final class Version20210908021401 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE save ADD user_id INT NOT NULL, ADD ranking INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE save DROP user_id, DROP ranking');
    }
}
